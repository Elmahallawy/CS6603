...
void loop() {
  ...
  if (current_time - previous_time >= transmission_interval) {
    ...
    //Set values to send
    timesend.id = BOARD_ID;
    timesend.timesync = TIME_LINEUP;
    ...
    */
    ...
    esp_now_send(client_one_address, (uint8_t *) &timesend, sizeof(timesend));

    esp_now_send(client_two_address, (uint8_t *) &timesend, sizeof(timesend));
